...
/**
 * Menangkap frame video ke canvas lalu memutarnya maju-mundur (boomerang) 30fps.
 * Selama frame belum siap (atau video gagal / prefers-reduced-motion), poster dipakai.
 */
export default function BoomerangVideoBg({ src, poster, className }: Props) {
